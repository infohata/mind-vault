...
| Grok action not installed | `GROK_NOT_INSTALLED=true` (no `grok-code-review.yml` workflow) | Same self-exclude / loud explicit pattern as claude; see [`engine-grok.md`](engine-grok.md) + [`docs/GROK_BUILD.md`](../../../docs/GROK_BUILD.md) (`XAI_API_KEY`). |
