...
- [references/SHELL_INSTALLERS.md](references/SHELL_INSTALLERS.md) — authoring + review patterns for `install/install-*.sh`; 15 patterns (pipefail family, chown, marker blocks, opt-out sweep, case-vs-grep security validation, etc.) distilled from review-loop cycles across PRs #55/#58/#59
