...
- {{Tempting adjacent work that is explicitly deferred. When the justification is a claim about the surrounding context ("fine while X"), write the invalidating condition and what its expiry obligates — see references/DEFERRAL_EXPIRY_TRIGGERS.md.}}
