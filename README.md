...
## Commands (15 slash commands across `commands/` and `skills/`)

Slash commands come from two sources: 7 in `commands/` (review/PR/utility) and 8 from sprint-workflow skills' frontmatter (one slash command per stage).
