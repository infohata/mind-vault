...
- Use `ScheduleWakeup` for adaptive polling (180s warm; 1200s+ for longer waits). Copilot review latency does not count against the 60-minute active-work budget.
