...
**Focus**: Validate patterns work, identify edge cases, stress-test concepts
...
- Collaborate with Architect on pattern testability
- Collaborate with DevOps on test infrastructure and CI/CD automation
...
1. **Receive documentation** from Documentation/UX (draft pattern with examples)
2. **Validate examples**:
...
7. **Hand off** to Curator/Reviewer with findings
