...
- **Fixed** `tools/sprint-auto-bootstrap.sh` sed delimiter collision in SALT/HMAC sentinel generation — pipe `|` was ambiguous inside credential-value regex; switched to a safer delimiter. (2026-04-21, [#56](https://github.com/infohata/mind-vault/pull/56))
