...
> **Deprecated (v4.2).** Prefer `/review-loop <PR> copilot` directly. This thin wrapper will be removed in a future release; dropping it trims the always-loaded command surface and reduces initial token toll.
