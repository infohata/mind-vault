...
# /bugbot - Automated Code Review & PR Creation
...
The bugbot command should:
1. Check current git status and branch
2. Generate appropriate commit message based on changes
3. Push to remote if needed
4. Create/update PR with comprehensive description
5. Invoke bugbot for automated code review
