...
- **Verification — DONE (2026-06-03).** teisutis PR #515 (onboarding: fixed workflows + tools) merged to `main`; forward-synced into the IDEA-214 branch; marked ready-for-review → claude posted a **summary + 2 inline findings**. The fixes hold: a posting-capable, non-draft run produces a real, readable verdict. (The dominant blocker turned out to be LAYER 0 / draft, with the LAYER 1/2 fixes also in place.)
