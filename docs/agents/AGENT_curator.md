...
**Focus**: Ensure quality, prevent duplication, maintain consistency
...
1. **Receive PR** with new skill/rule from development
...
3. **Validate against quality checklist**:
   - [ ] File follows naming convention (SKILL_, RULE_, AGENT_)
...
6. **Validate scope**:
   - Is content focused (not >500 lines)?
